...
$(window).on('load', function() {
	...
	$("#form").on("submit", function(){
	    $('<div id="preloder"><section class="process-section spad" id="why"><div class="container"><div class="section-title text-center"><h2>Please wait while we verify your information...</h2></div></div></section><div class="loader"></div></div>').prependTo(document.body);
